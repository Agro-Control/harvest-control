...
const getOperationalTime = async (grupo_id: number | null,  empresa_id: number | null) => {
...
export const useGetOperationalTime = (grupo_id: number | null,  empresa_id: number | null) => {
    return useQuery({
