...
export function DateTimePicker({value, onChange, placeHolder}: DatePickerProps) {
    ...
    return (
        <div className="flex h-10 w-full gap-1 flex-row items-center rounded-xl border border-divider bg-white py-2 text-sm placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-green-800 focus-visible:ring-offset-0">
            <Popover>
